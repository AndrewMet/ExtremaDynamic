...
async function NewtonDraw() {
    ...
    for(let i=1; i<=x.zerocount; i++)
    {
        ...
        {
            document.getElementById("status").innerText+="Корень производной ="+xnext+" найден с нужной точностью. Это не точка экстремума.";
        }
